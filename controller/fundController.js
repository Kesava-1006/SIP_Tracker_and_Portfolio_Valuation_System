...
const {insertFund,getAllFunds, updateFundNavv} = require('../model/fundModel')
...
const InsertFunds = async (request, response) => {
    ...
    const fundresult = await insertFund(amc_id, fund_name, fund_type, risk_level, current_nav, created_at);
